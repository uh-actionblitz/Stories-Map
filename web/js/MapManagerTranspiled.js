...
var MapManager = function ($, d3, leaflet) {
  return function (eventData, campaignOffices, zipcodes, options) {
    ...
    var accessToken = "pk.eyJ1IjoicmFwaWNhc3RpbGxvNTI5IiwiYSI6ImNqMWg4YXJkZTAwN28yd2xteDg5MTdsNGYifQ.zKX42OOlgxiio-Dr4RGGTA";
    var mapboxTiles = leaflet.tileLayer('https://{s}.tiles.mapbox.com/v4/mapbox.streets/{z}/{x}/{y}.png?access_token=' + accessToken, { attribution: '<a href="http://www.openstreetmap.org/copyright" target="_blank">&copy; OpenStreetMap contributors</a>'});
